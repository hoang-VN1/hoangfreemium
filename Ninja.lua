...
local MobileButton = Minimizer:CreateMobileMinimizer({
  Image = "rbxassetid://116164900791743",
...
Tabs.Info:AddDiscordInvite({
	Title = "Ninja hub | Community",
	Description = "A community for Ninja hub Users - official scripts, updates, and suport in one place.",
	Banner = "rbxassetid://116164900791743", 
	Logo = "rbxassetid://116164900791743",
	Invite = "https://discord.gg/hzkP9m6h87",
	Members = 3600000, 
	Online = 3200, 
})
